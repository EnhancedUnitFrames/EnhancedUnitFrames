...
hooksecurefunc("PlayerFrame_ToPlayerArt", function(self)
	if cfg.bigPlayerHealthBars then
		if cfg.elitePlayerFrame then
			PlayerFrameTexture:SetTexture("Interface\\TargetingFrame\\TargetFrameElite")
		elseif cfg.rareElitePlayerFrame then
			PlayerFrameTexture:SetTexture("Interface\\TargetingFrame\\TargetFrameRareElite")
		elseif cfg.rarePlayerFrame then
			PlayerFrameTexture:SetTexture("Interface\\TargetingFrame\\TargetFrameRare")
		else
			PlayerFrameTexture:SetTexture("Interface\\TargetingFrame\\TargetFrame")
		end
