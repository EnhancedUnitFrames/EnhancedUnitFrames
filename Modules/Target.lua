	...
	hooksecurefunc("TargetFrame_CheckClassification", function(self, forceNormalTexture)
		...
		local function Styling()
			...
			if isClassic() then
				...
				TargetFrameHealthBar.RightText:SetPoint("RIGHT", self.healthbar, -4, -0.5)
				...
				TargetFrameManaBar.RightText:SetPoint("RIGHT", self.manabar, -4, 0)
				...
				self.healthbar.RightText:SetPoint("RIGHT", self.healthbar, -4, -0.5)
				...
				self.manabar.RightText:SetPoint("RIGHT", self.manabar, -4, 0)
