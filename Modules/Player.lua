function PlayerFrameStyling()
	...
	hooksecurefunc("PlayerFrame_ToPlayerArt", function(self)
		...
		PlayerFrameHealthBar.LeftText:SetPoint("LEFT", PlayerFrameHealthBar, -2, -0.5)
		...
		PlayerFrameHealthBar.RightText:SetPoint("RIGHT", PlayerFrameHealthBar, -3, -0.5)
		...
		PlayerFrameManaBar.RightText:SetPoint("RIGHT", PlayerFrameManaBar, -3, 0)
