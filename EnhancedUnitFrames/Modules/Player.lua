function PlayerFrameStyling()
	...
	hooksecurefunc("PlayerFrame_ToPlayerArt", function(self)
		local function BigStyling()
			...
			PlayerFrameManaBar.LeftText:SetPoint("LEFT", PlayerFrameManaBar, -1.5, -0.5)
			PlayerFrameManaBar.RightText:ClearAllPoints()
			PlayerFrameManaBar.RightText:SetPoint("RIGHT", PlayerFrameManaBar, -3.5, -0.5)
			PlayerFrameManaBar.TextString:ClearAllPoints()
			PlayerFrameManaBar.TextString:SetPoint("CENTER", PlayerFrameManaBar, 0, -0.5)
		...
		local function WhoaStyling()
			...
			if isClassic() then
				PlayerFrameAlternatePowerBar.LeftText:SetJustifyH("RIGHT")
				PlayerFrameAlternatePowerBar.LeftText:SetWidth(40)
				PlayerFrameAlternatePowerBar.LeftText:SetPoint("LEFT", -6.5, 0)
				PlayerFrameAlternatePowerBar.RightText:SetJustifyH("RIGHT")
				PlayerFrameAlternatePowerBar.RightText:SetWidth(75)
				PlayerFrameAlternatePowerBar.RightText:SetPoint("RIGHT")
				PlayerFrameAlternatePowerBar.TextString:SetPoint("CENTER")
			else
				...
				PlayerFrameAlternateManaBar.LeftText:SetJustifyH("RIGHT")
				PlayerFrameAlternateManaBar.LeftText:SetWidth(40)
				PlayerFrameAlternateManaBar.LeftText:ClearAllPoints()
				PlayerFrameAlternateManaBar.LeftText:SetPoint("LEFT", -6.5, 0)
				PlayerFrameAlternateManaBar.RightText:SetJustifyH("RIGHT")
				PlayerFrameAlternateManaBar.RightText:SetWidth(75)
		...
		PlayerFrameGroupIndicatorText:SetAlpha(1)
