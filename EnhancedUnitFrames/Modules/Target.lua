function TargetFrameStyling()
	...
	local function AuraStyling()
		hooksecurefunc("TargetFrame_UpdateAuraPositions", function(self, auraName, numAuras, numOppositeAuras, largeAuraList, updateFunc, maxRowWidth, offsetX, mirrorAurasVertically)
			...
			if selfName and selfName:match("TargetFrame") then
	...
	hooksecurefunc("TargetFrame_CheckClassification", function(self, forceNormalTexture)
		...
		local function TargetStyling()
			local function BigStyling()
				...
				TargetFrameManaBar.LeftText:SetPoint("LEFT", TargetFrame.manabar, -1.5, -0.5)
				TargetFrameManaBar.RightText:ClearAllPoints()
				TargetFrameManaBar.RightText:SetPoint("RIGHT", TargetFrame.manabar, -3.5, -0.5)
				TargetFrameManaBar.TextString:ClearAllPoints()
				TargetFrameManaBar.TextString:SetPoint("CENTER", TargetFrame.manabar, 0, -0.5)
			end
